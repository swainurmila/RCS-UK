                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs" id="bylawTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="society-tab" data-bs-toggle="tab"
                                        data-bs-target="#society" type="button"
                                        role="tab">{{ __('messages.society_placeholder') }}</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="committee-tab" data-bs-toggle="tab"
                                        data-bs-target="#committee" type="button"
                                        role="tab">{{ __('messages.ManagingCommittee') }}</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="aamshabha-tab" data-bs-toggle="tab"
                                        data-bs-target="#aamshabha" type="button"
                                        role="tab">{{ __('messages.Aam Sabha Meeting') }}</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="voting-tab" data-bs-toggle="tab" data-bs-target="#voting"
                                        type="button" role="tab">{{ __('messages.VotingonAmendments') }}</button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="bylawTabsContent">
                                    ...
                                    <form id="step_form1" action="{{ route('societyRegister') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">{{ __('messages.Nameofthesociety') }}<span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select form-control" name="society_name" required>
                                                    <option value="">{{ __('messages.select') }}</option>
                                                    @foreach ($socity_details as $society)
                                                        <option value="{{ $society->id }}"
                                                            {{ isset($societyDetails) && $societyDetails->id == $society->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">{{ __('messages.TotalNoofMembers') }}<span
                                                        class="text-danger">*</span></label>
                                                <input type="number" class="form-control" name="total_members"
                                                    oninput="myFunction()" required
                                                    value="{{ old('total_members', $amendment->total_members ?? '') }}">
                                                ...
                                                <select class="form-select form-control" name="district" id="district">
                                                    ...
                                                    @foreach ($districts as $district)
                                                        <option value="{{ $district->id }}"
                                                            {{ isset($amendment) && $amendment->district == $district->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select form-control" name="block" id="block">
                                                    <option value="">-- Select --</option>
                                                    @if (!empty($amendment->block))
                                                        @foreach ($blocks as $block)
                                                            <option value="{{ $block->id }}"
                                                                {{ isset($amendment) && $amendment->block == $block->id ? 'selected' : '' }}>
                                                                {{ $block->name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">{{ __('messages.SocietyAddress') }}<span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">{{ __('messages.UploadE-18Certificate') }}<span
                                                        class="text-danger">*</span></label>
                                                <input type="file" class="form-control" oninput="myFunction()"
                                                    name="e18_certificate" required>
                                                @if (!empty($amendment->e18_certificate))
                                                    @php
                                                        $url = asset('storage/' . $amendment->e18_certificate);
                                                        $ext = pathinfo(
                                                            $amendment->e18_certificate,
                                                            PATHINFO_EXTENSION,
                                                        );
                                                        $icon =
                                                            $ext === 'pdf'
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label" hidden>{{ __('messages.Society Act') }}<span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label" hidden>Area of Operation<span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label
                                                    class="form-label">{{ __('messages.TotalNoOfElectedBoardMembers') }}<span
                                                        class="text-danger">*</span></label>
                                                <input type="number" class="form-control" oninput="myFunction()"
                                                    name="board_members" required
                                                    value="{{ old('board_members', $amendment->total_board_members ?? '') }}">
                                                <span id="board_members_error" class="text-danger1"></span>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label
                                                    class="form-label">{{ __('messages.NoofMembersRequiredforQuorum') }}<span
                                                        class="text-danger">*</span></label>
                                                <input type="number" class="form-control" oninput="myFunction()"
                                                    name="quorum" required
                                                    value="{{ old('quorum', $amendment->quorum_members ?? '') }}">
                                        ...
                                        <div class="text-end">
                                            <button type="button" class="btn btn-sf-green" id="submit_btn1"
                                                data-nexttab="committee-tab-btn" onclick="nextStep(1)">
                                                {{ isset($amendment) && $amendment->id ? __('messages.Update & Continue') : __('messages.Save & Continue') }}</button>
                                        </div>
                                    </form>
                                </div>

                                {{-- Managing Committee Tab --}}
                                <div class="tab-pane fade border p-4" id="committee" role="tabpanel"
                                    aria-labelledby="committee-tab">
                                    <form id="step_form2" action="{{ route('societyRegister') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">{{ __('messages.UploadExistingBy-Law') }}<span
                                                        class="text-danger">*</span></label>
                                                <input type="file" id="momfile1" name="existing_bylaw"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label
                                                    class="form-label">{{ __('messages.UploadRelevantSectionofBy-LawtobeAmended') }}<span
                                                        class="text-danger">*</span></label>
                                                <input type="file" id="momfile2" name="bylaw_section"
                                                    class="form-control" onchange="validateFile(this)"
                                                    oninput="myFunction()" required>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">{{ __('messages.ProposedAmendment') }}<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="releventsection"
                                                    name="proposed_amendment" oninput="myFunction()"
                                                    value="{{ old('proposed_amendment', optional($managingCommittee)->proposed_amendment) }}"
                                                    required>
                                                <span id="proposed_amendment_error" class="text-danger1"></span>
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">{{ __('messages.PurposeofAmendment') }}<span
                                                        class="text-danger">*</span></label>
                                                <textarea class="form-control" id="reasonofamendment" name="purpose_of_amendment" rows="4"
                                                    oninput="myFunction()" required>{{ old('purpose_of_amendment', optional($managingCommittee)->purpose_of_amendment) }}</textarea>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="file" id="registration_certificate"
                                                    ...
                                                    onchange="validateFile(this)" oninput="myFunction()" required
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label">{{ __('messages.UploadDocumentApprovedbyManagingCommitteeBoard') }}<span
                                                            class="text-danger">*</span></label>
                                                    <div>
                                                        <input class="form-check-input" type="radio" id="approvalYes"
                                                            name="approval" value="yes" onchange="toggleFileUpload()"
                                                            {{ old('approval', optional($managingCommittee)->approval) == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="approvalYes">{{ __('messages.yes') }}</label>

                                                        <input class="form-check-input" type="radio" id="approvalNo"
                                                            name="approval" value="no" onchange="toggleFileUpload()"
                                                            {{ old('approval', optional($managingCommittee)->approval) == 'no' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="approvalNo">{{ __('messages.no') }}</label>
                                                    </div>
                                                    <span id="approval_error" class="text-danger"></span>
                                                    <div id="fileUploadContainer" class="mt-2"
                                                        style="{{ old('approval', optional($managingCommittee)->approval) == 'yes' ? 'display:block;' : 'display:none;' }}">
                                                        <input type="file" id="momfile3"
                                                            name="committee_approval_doc" class="form-control"
                                                        ...
                                                        <span id="committee_approval_doc_error"
                                ...
                                <div class="tab-pane fade border p-4" id="aamshabha" role="tabpanel"
                                    aria-labelledby="aamshabha-tab">
                                    <form id="step_form3" action="{{ route('societyRegister') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('messages.Notice of Aam Sabha') }}<span
                                                        class="text-danger1">*</span></label>
                                                <div>
                                                    <input type="radio" id="noticeOfAamSabhaYes"
                                                        name="noticeOfAamSabha" value="1"
                                                        onclick="toggleCommunicationMethod(true)"
                                                        {{ old('noticeOfAamSabha', optional($aamSabhaMeeting)->noticeOfAamSabha) == '1' ? 'checked' : '' }}>
                                                    <label for="noticeOfAamSabhaYes"
                                                        class="me-3">{{ __('messages.yes') }}</label>

                                                    <input type="radio" id="noticeOfAamSabhaNo" name="noticeOfAamSabha"
                                                        value="0" onclick="toggleCommunicationMethod(false)"
                                        ...
                                        <div class="row" id="communicationAndUploadRow"
                                            ...
                                            <div class="col-lg-3">
                                                <label
                                                    class="form-label">{{ __('messages.ModeofCommunicationtoMembers') }}<span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select" id="communicationMethod"
                                                    name="communication_method" oninput="myFunction()"
                                                    onchange="toggleOtherMethodField()">
                                                    <option value="">{{ __('messages.select') }}</option>
                                            ...
                                            <div class="col-lg-3" id="otherMethodField"
                                                ...
                                                <label
                                                    class="form-label">{{ __('messages.OtherModeofCommunicationtoMembers') }}<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="otherMethodInput"
                                            ...
                                            <div class="col-lg-3">
                                                <label class="form-label">Schedule Date of AG Meeting <span
                                                        class="text-danger">*</span></label>
                                                <input type="date" class="form-control" id="scheduledMeetingDate"
                                                    name="ag_meeting_date"
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                <label
                                                    class="form-label">{{ __('messages.Upload Meeting Notice (PDF only)') }}<span
                                                        class="text-danger">*</span></label>
                                                <input type="file" class="form-control" id="momfile4"
                                                    name="meeting_notice" oninput="myFunction()"
                                        ...
                                        <div class="text-end">
                                            <button type="button" class="btn btn-secondary"
                                                onclick="navigateToTab('committee-tab')">Previous</button>
                                            <button type="button" class="btn btn-sf-green" id="submit_btn3"
                                                onclick="nextStep(3)">{{ isset($amendment) && $amendment->id ? __('messages.Update & Continue') : __('messages.Save & Continue') }}</button>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="tab-pane fade border p-4" id="voting" role="tabpanel"
                                    aria-labelledby="voting-tab">
                                    <form id="step_form4" action="{{ route('societyRegister') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    <label class="form-label">{{ __('messages.TotalNoofMembers') }}<span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" onkeyup="myFunction()"
                                                        oninput="calculateVotingDetails()" id="totalMembersVoting"
                                                        name="total_members"
                                                        value="{{ old('total_members', optional($votingOnAmendments)->total_members) }}">
                                                    <span id="totalMembersError" class="text-danger1"></span>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    <label class="form-label">{{ __('messages.NoofMembersPresent') }}<span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" onkeyup="myFunction()"
                                                        oninput="calculateVotingDetails()" id="membersPresent"
                                                        name="members_present"
                                                        value="{{ old('members_present', optional($votingOnAmendments)->members_present) }}">
                                                    <span id="membersPresentError" class="text-danger1"></span>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    <label class="form-label">Is Quorum Completed?<span
                                                            class="text-danger">*</span></label>
                                                    <div>

                                                        <input type="radio" name="quorum_completed" value="1"
                                                            onclick="toggleVotingFields(true)"
                                                            {{ old('quorum_completed', optional($votingOnAmendments)->quorum_completed) == '1' ? 'checked' : '' }}>
                                                        {{ __('messages.yes') }}

                                                        <input type="radio" name="quorum_completed" value="0"
                                                            onclick="toggleVotingFields(false)"
                                        ...
                                        <div class="row" id="votingFields" style="display: none;">
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label">{{ __('messages.VotedInfavourofAmendment') }}<span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" onkeyup="myFunction()"
                                                        oninput="calculateVotingDetails()" id="infavno"
                                                        name="votes_favor"
                                                        value="{{ old('votes_favor', optional($votingOnAmendments)->votes_favor) }}">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label">{{ __('messages.VotedAgainstAmendment') }}<span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" onkeyup="myFunction()"
                                                        oninput="calculateVotingDetails()" id="disfavno"
                                                        name="votes_against"
                                                        value="{{ old('votes_against', optional($votingOnAmendments)->votes_against) }}">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label">{{ __('messages.NoOfMembersVoted') }}</label>
                                                    <input type="number" class="form-control" id="totalVoted"
                                                        name="total_voted"
                                                        value="{{ old('total_voted', optional($votingOnAmendments)->total_voted) }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label">{{ __('messages.NoOfMembersAbstain') }}</label>
                                                    <input type="number" class="form-control" id="abstainMembers"
                                                        name="abstain_members"
                                                        value="{{ old('abstain_members', optional($votingOnAmendments)->abstain_members) }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label">{{ __('messages.ManagingCommitteeResolutionforAmendment') }}<span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label">{{ __('messages.Upload Resolution (PDF)') }}<span
                                                            class="text-danger">*</span></label>
                                                    <input type="file" id="momfile6" name="resolution_file"
                                        ...
                                        <div class="text-end">
                                            ...
                                            <button type="button" class="btn btn-sf-green" id="submit_btn4"
                                                onclick="nextStep(4)">{{ isset($amendment) && $amendment->id ? __('messages.Final Update') : __('messages.Final Submit') }}</button>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        ...
        function validateStep(step) {
            ...
            switch (step) {
                ...
                case 2: // Managing Committee Tab Validation
                    ...
                    let exist_committee_approval_doc =
                        {{ @$managingCommittee->committee_approval_doc ? 'true' : 'false' }};
                    let exist_registration_certificate =
                        {{ @$managingCommittee->registration_certificate ? 'true' : 'false' }};
                    ...
                    if (!$('input[name="approval"]:checked').val()) {
                        ...
                        if ($('input[name="approval"]:checked').val() == "yes") {
                            ...
                            if ((!approvalDocInput || approvalDocInput.value === "") && !exist_committee_approval_doc) {
                                isValid = false;
                                $('#committee_approval_doc_error').text(
                                    'Please upload the document approved by Managing Committee Board.');
                    ...
                    if (!$('input[name="noticeOfAamSabha"]:checked').val()) {
                        ...
                        if ($('input[name="noticeOfAamSabha"]:checked').val() == '1') {
                            if ($('select[name="communication_method"]').val() === '') {
                                isValid = false;
                                $('#communication_method_error').text(
                                'Please select the Mode of Communication to Members.');
        ...
        function calculateVotingDetails() {
            ...
            if (totalVoted > membersPresent) {
                disfavnoError.textContent =
                    "Sum of Infavour No and Disfavour No cannot be greater than No. of Members Present.";
                disfavnoInput.value = ""; // Reset the field
                return;
            }
