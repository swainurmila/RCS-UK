    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">{{ __('messages.SocietyAuditList') }}</h4>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                             @foreach($societyAudits as $key => $audit)
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    <td>{{ $audit->appDetail->app_no ?? 'N/A' }}</td>
                                    <td>{{ ucfirst($audit->societyDetails->society_type ?? 'N/A') }}</td>
                                    <td>{{ $audit->society_details->society_name ?? 'N/A' }}</td>
                                    <td>{{ $audit->society_details->society_email ?? 'N/A' }}</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @if($roleId == 7 && ($audit->status == 'pending' || $audit->status == 'rejected'))
                                        <a href="{{ route('society.audits.edit', $audit->id) }}" class="btn btn-sm btn-primary">
