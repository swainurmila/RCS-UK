                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{ $value->society_details->society_category ?? 'N/A' }}</td>
                                ...
                                <td>
                                    @if ($value->status == 1)
                                    <span class="badge {{ $value->days_left_badge['class'] }}">
                                        {{ $value->days_left_badge['text'] }}
                                    </span>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-info view-application"
                                        ...
                                        data-bs-target="#viewSocietyModal"><i class="fas fa-eye"></i></button>
                                    @endif
                                    @if ($roleId == 7 && ($value->status == 0 || $value->status == 3))
                                    <a href="{{ route('society.edit', $value->id) }}"
...
<script>
    ...
    $(document).ready(function() {
     ...
     $('#submitActionBtn').on('click', function (e) {
    e.preventDefault(); 
