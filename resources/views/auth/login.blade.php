            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="society-form">
                        ...
                        <form method="POST" action="{{ route('user-login') }}" id="society-form">
                            @csrf
                            ...
                            <div class="form-step1">
                                ...
                                <div class="mt-1 text-end">
                                    <button type="submit"
                                        class="btn submit-btn w-100" id="login-btn">{{ __('messages.Login') }}</button>
                                    <button type="button"
                                        class="btn submit-btn w-100" id="loader" style="display: none;">Logging in....</button>
                                    <!-- <div id="loader" style="display: none;">logingIn...</div> -->
                                </div>
                            </div>
...
@section('js')
<script>
     document.getElementById('society-form').addEventListener('submit', function() {
        // Show loader
