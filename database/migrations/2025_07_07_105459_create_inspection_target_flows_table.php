...
return new class extends Migration
{
    ...
    {
        Schema::create('inspection_target_flows', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('inspection_target_id');
            ...
            $table->foreign('inspection_target_id')->references('id')->on('inspection_targets')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('inspection_target_flows');
    }
};
